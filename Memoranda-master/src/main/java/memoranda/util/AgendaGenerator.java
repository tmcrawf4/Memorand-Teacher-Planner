...
=======*/
	...
	static String generateEventsInfo(CalendarDate date) {
		...
		Vector v = (Vector) EventsManager.getEventsForDate(date, currentUserRank);
		int n = 0;
	...
	static String generateStickers(CalendarDate date) {
		...
		String iurl2 =
				...
				.toExternalForm();
		// Translated Importar anotacion into english
		// and translated Exportar anotacion como into english
		// third change was translating Exportar anotaci�n como .html into english
