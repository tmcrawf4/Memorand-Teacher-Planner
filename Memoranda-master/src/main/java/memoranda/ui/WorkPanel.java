...
public class WorkPanel extends JPanel {
	...
	public JButton loginB = new JButton();
	...
	void jbInit() throws Exception {
		...
		// US28 LOGIN BUTTON
		loginB.setSelected(true);
		loginB.setMargin(new Insets(0, 0, 0, 0));
		loginB.setIcon(
				new ImageIcon(
						main.java.memoranda.ui.AppFrame.class.getResource(
								"/ui/icons/login.png")));
		loginB.setVerticalTextPosition(SwingConstants.BOTTOM);
		loginB.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(ActionEvent e) {
				loginB_actionPerformed(e);
			}
		});
		loginB.setFont(new java.awt.Font("Dialog", 1, 10));
		loginB.setVerticalAlignment(SwingConstants.TOP);
		loginB.setText(Local.getString("Login"));
		loginB.setHorizontalTextPosition(SwingConstants.CENTER);
		loginB.setFocusPainted(false);
		loginB.setBorderPainted(false);
		loginB.setContentAreaFilled(false);
		loginB.setPreferredSize(new Dimension(50, 50));
		loginB.setMinimumSize(new Dimension(30, 30));
		loginB.setOpaque(false);
		loginB.setMaximumSize(new Dimension(60, 80));
	...
	public void selectPanel(String pan) {
		if (pan != null) {
			...
			else if (pan.equals("LOGIN"))
				loginB_actionPerformed(null);
		}
	}
	...
	public void loginB_actionPerformed(ActionEvent e) {
		cardLayout1.show(panel, "LOGIN");
		setCurrentButton(loginB);
		Context.put("CURRENT_PANEL", "LOGIN");
	}
