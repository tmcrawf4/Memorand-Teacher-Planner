...
public class AltHTMLWriter extends AbstractWriter {
    ...
    protected void emptyTag(Element elem) throws BadLocationException, IOException {
        ...
        if (attr != null) {
            ...
            if (matchNameAttribute(attr, HTML.Tag.CONTENT)) {
                ...
                boolean isBlock = isBlockTag(attr);
                ...
                if (nameTag != null && endTag instanceof String && ((String) endTag).equals("true")) {
                    outputEndTag = true;
                }
    ...
    class OptionListModel extends DefaultListModel implements ListSelectionModel, Serializable, Cloneable {
        ...
        protected EventListenerList taskListenerList = new EventListenerList();
