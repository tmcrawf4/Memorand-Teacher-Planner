...
public class EventNotificationDialog extends JFrame {
    ...
    //Event notification dialog accepts and stores a new string for eventDialog called topic
    public EventNotificationDialog(String title, String time, String text, String topic, File file) {
        super();
        this.setTitle(title);
        try {
            jbInit();
        ...
        // set the text of the JLabel topicLabel to the value of topic
    ...
    void jbInit() throws Exception {
        ...
        panel1.add(topicLabel, BorderLayout.EAST);
        panel1.add(fileNameLabel, BorderLayout.WEST);
    ...
    private void playSoundNotification() {
        ...
        try {
            ...
            /*DEPRECIATED - The Applet API is depreciated
